...
- 题库：新增、编辑、答案/解析/公式/计算题专项字段、图片附件。
...
- LaTeX：支持 `$...$` 和 `$$...$$`。
- 搜索筛选：章节、标签、难度、题型、来源、关键词、待完善、无答案、无解析等。
...
- 一键同步：配置 Supabase 并登录后，进入“资料识别”页面，点击“同步内置资料到数据库”，会把未重复的来源、题目和知识点写入数据库。内置资料来自当前项目文件夹中已解析的 PPT、作业和真题来源。
...
- `期末/2025-期末试卷回顾.pdf`、`期末/2023-半导体集成电路-期末-无答案.pdf`、部分 2020/2021/2022 真题 PDF：文本抽取结果乱码或像扫描 OCR，已作为“待整理来源”。
